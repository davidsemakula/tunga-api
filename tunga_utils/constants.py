...
# Project Types
PROJECT_DURATION_4_WEEKS = '4w'
PROJECT_DURATION_3_MONTHS = '3m'
PROJECT_DURATION_6_MONTHS = '6m'
PROJECT_DURATION_12_MONTHS = '12m'
PROJECT_DURATION_PERMANENT = 'permanent'

PROJECT_EXPECTED_DURATION_CHOICES = (
    (PROJECT_DURATION_4_WEEKS, '2-4 Weeks'),
    (PROJECT_DURATION_3_MONTHS, '1-3 Months'),
    (PROJECT_DURATION_6_MONTHS, '3-6 Months'),
    (PROJECT_DURATION_12_MONTHS, '6-12 Months'),
    (PROJECT_DURATION_PERMANENT, 'Permanent')
)

# Project Types
PROJECT_CATEGORY_PROJECT = 'project'
PROJECT_CATEGORY_DEDICATED = 'dedicated'
...
PROJECT_CATEGORY_TUNGA_PROJECT = 'tunga_project'
PROJECT_CATEGORY_OTHER = 'other'

PROFILE_PROJECT_CATEGORY_CHOICES = (
    (PROJECT_CATEGORY_TUNGA_PROJECT, 'Tunga Project'),
    (PROJECT_CATEGORY_OTHER, 'Other')
)
...
INVOICE_TYPE_SALE_DUE_DATE = 14
INVOICE_TYPE_PURCHASE_DUE_DATE = 5
...
PROGRESS_REPORT_STATUS_AHEAD = 'ahead'
